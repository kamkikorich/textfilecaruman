    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <header className="border-b border-white/[0.08] bg-slate-900/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-xl text-white">New Announcement</h1>
              <p className="text-sm text-slate-400">Create a system-wide announcement</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
          ...
          {/* Schedule (optional) */}
          <div className="space-y-4 rounded-xl border border-white/[0.08] bg-slate-900/50 p-6">
            <h3 className="font-semibold text-white">Schedule (Optional)</h3>
