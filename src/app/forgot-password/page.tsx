...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass rounded-2xl p-8 animate-fade-in">
        <div className="space-y-1 mb-8">
          ...
          <p className="text-slate-400 text-sm">
            Masukkan email anda untuk menerima link reset kata laluan
          </p>
        </div>
            ...
            <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-start gap-3 text-emerald-400 text-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-400 text-xs">
                  Link reset akan tamat dalam masa 1 jam. Sila semak folder spam jika tidak jumpa.
                </p>
              </div>
            </div>
            <Button
      ...
      <Link href="/login" className="mt-8 text-sm text-slate-500 flex items-center gap-2 hover:text-slate-300 transition-colors">
